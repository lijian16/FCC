...
import cv2
import os
from fcc.fcc_functions import fcc 
...
class Network(nn.Module):
    ...
    def forward(self, x, **kwargs):
        ...
        elif 'feature_fcc_flag' in kwargs:
            return self.extract_feature_with_fcc(x, **kwargs)
    ...
    def extract_feature_with_fcc(self, x, **kwargs):
        x = self.backbone(x)
